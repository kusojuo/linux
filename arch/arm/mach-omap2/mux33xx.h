...
#define AM33XX_CONTROL_PADCONF_MUX_WKUP_PBASE			\
		AM33XX_CONTROL_PADCONF_MUX_PBASE
#define AM33XX_CONTROL_PADCONF_MUX_WKUP_SIZE			\
		(AM33XX_CONTROL_PADCONF_VREFN_OFFSET + 0x4)

#define AM33XX_CONTROL_PADCONF_MUX_PER_PBASE			\
		(AM33XX_CONTROL_PADCONF_MUX_PBASE +		\
		 AM33XX_CONTROL_PADCONF_GPMC_A0_OFFSET)
